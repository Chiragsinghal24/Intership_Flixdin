...
<div class="p-4 rounded-2xl ml-28">
  <div class=" bg-[#F7EAA9] border rounded-2xl max-w-md">
    ...
    <div class="font-semibold text-sm mx-4 mt-4 flex">Nicholas</div>
    <div class="text-sm mx-4 mb-4 flex text-left">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Doloribus nobis perferendis porro atque dolor </div>
  </div>
</div>
    </>
  )
